...
import { graph2 } from '../../../assets/Images';
import {
  Button,
  Container,
  InnerContainer,
...
const HeroSection = () => {
  return (
    <Container>
      <InnerContainer
        className={'mt-[66px] gap-[16px] md:gap-[24px] md:mt-[100px]'}
      >
        ...
        {/* <Typography
        variant='body2'
        className='text-[11px] leading-[11px] uppercase md:text-[16px] md:leading-[16px] text-center'
      >
